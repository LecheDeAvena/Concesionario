...
public class Empleado {
	...
	public Empleado(String nomEmp, String apeEmp, String gmaEmp, String tlfEmp, String dirEmp, int salEmp, Date fecIni,
			String dniEmp, String conEmp, Concesionario concesionario) {
		this.nomEmp = nomEmp;
		this.apeEmp = apeEmp;
		this.gmaEmp = gmaEmp;
		this.dirEmp = dirEmp;
