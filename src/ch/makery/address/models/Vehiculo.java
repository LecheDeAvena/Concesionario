...
public class Vehiculo implements Serializable{
  ...
  public Vehiculo(String marca, String color, Date fecLle, int preVeh, String matVeh, String tipVeh, String tipGas, String modVeh, Concesionario concesionario, Cliente cliente) {
    super();
    this.marca = marca;
    this.color = color;
    this.fecLle = fecLle;
  ...
  public Vehiculo(String marca, String color, Date fecLle, int preVeh, String matVeh, String tipVeh, String tipGas, String modVeh) {
    super();
    this.marca = marca;
    this.color = color;
    this.fecLle = fecLle;
